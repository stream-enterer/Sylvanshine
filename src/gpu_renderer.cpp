...
void GPURenderer::draw_sprite(GPUTextureHandle& texture, const SDL_FRect& src,
...
void GPURenderer::draw_sprite_dissolve(GPUTextureHandle& texture, const SDL_FRect& src,
